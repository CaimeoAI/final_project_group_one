    ...
    >
      ...
      <div className="w-[90%]  md:px-4">
        <div className="h-[80%] ">
          ...
          <div
            className={`${styles.textPost} h-[120px] md:h-[80px] md:mb-1 lg:pr-2  text-ellipsis overflow-hidden mb-5`}
          >
            {post.content}
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-row w-[100%] py-2 ">
              ...
              <div className={`flex flex-row w-[50%] `}>
                  <div className={`${styles.flexRow} mr-4 `}>
                      ...
                      <p className={`${styles.textPost} ${styles.hoverText} cursor-pointer`}>5
                         <span> Comments</span>
                      </p>
                  </div>
                  <div className={`${styles.flexRow} `}>
                      ...
                      <p className={`${styles.textPost} ${styles.hoverText}  cursor-pointer`}>Save</p>
                  </div>
              </div>
