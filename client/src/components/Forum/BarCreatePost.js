  ...
  return (
    <>
      ...
      > 
        ...
        className="w-[95%] bg-secondary rounded-lg  hover:border hover:bg-transparent hover:border-slate-600 hover:transition hover:duration-60 hover:ease-in ease-out mr-5  md:p-4 md:py-4  focus:outline-none"/>
      </div>
    </>
  );
};
