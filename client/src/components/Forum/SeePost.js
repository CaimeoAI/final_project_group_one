    ...
    >
      ...
      <NavLink to={`/academia`}>
        <div className="flex justify-end  text-grayed-out font-semibold md:pr-2 py-3  hover:text-hover-primary">
          <IoArrowBackCircleOutline className="cursor-pointer mr-4 md:mx-2 w-[20px] h-[20px] md:w-[26px] md:h-[26px] " />
      ...
      <div className="flex flex-row  bg-secondary rounded-md shadow mx-4 md:mx-0">
        ...
        <div className="pl-5 py-4 ">
          <h1 className="text-md md:text-[23px]  text-grayed-out font-bold ">
            {singelPost.title}
          </h1>
          <div
      ...
      <div className={`px-4 md:py-6 md:px-10 text-text-primary  `}>
        <h1 className=" text-md md:text-[18px] text-accent-secondary   font-semibold md:pb-6 py-3">
          <span className="text-[18px] pr-1">{comments.length}</span> answers
        </h1>
        {comments.length > 0 &&
      ...
      {/* //---------- Form Section ----------- */}
      <div className="">
        <div className="w-[90%] md:w-[37%] lg:w-[52%]  pl-5 md:pl-0 md:text-center">
        <h1 className="text-sm md:text-[18px] font-semibold  mb-2 text-accent-secondary">
          Your answer
        </h1>
        </div>
